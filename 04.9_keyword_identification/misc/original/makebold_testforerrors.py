...
#%%%
raw_data = openpyxl.open_workbook(r"C:\Users\jasonjia\Dropbox\Projects\conference_call\output\04_keyword_identification\test\cric1_newtotal_truncated.xlsx").sheet_by_index(0)
...
row = 0 
col = 0
with open("C:\Users\jasonjia\Dropbox\Projects\conference_call\output\04_keyword_identification\04.2_reference_files\keyterms.txt", "r", encoding="utf-8", errors="ignore") as f1:
...
#%%% title
title_file = openpyxl.open_workbook(r"C:\Users\jasonjia\Dropbox\Projects\conference_call\output\04_keyword_identification\04.2_reference_files\Entry mask.xlsx").sheet_by_index(0)

#%%% overview
overview_file = xlsxwriter.Workbook("C:\Users\jasonjia\Dropbox\Projects\conference_call\output\04_keyword_identification\test\paragraphrecord_fromterminal.xlsx")
...
for row_val in range(1,raw_data.nrows):
    if row_val%500==1:
        if row_val//500>0:
            final_data.close()
        final_data = xlsxwriter.Workbook(r"C:\Users\jasonjia\Dropbox\Projects\conference_call\output\04_keyword_identification\test\entry_files\\"+ str(row_val//500+1) + ".xlsx")
