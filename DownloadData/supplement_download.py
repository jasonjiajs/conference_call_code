################## this file serves to download supplementary missing pdf-excel pairs #################
################## the main body is like the automatic_download.py ############
################## The difference is that this code takes a list of missing records (startdate-enddate-page) as input #####
