...
duplicates drop
duplicates drop Report, force // 1 observation deleted
...
export excel using "C:\Users\jasonjia\Dropbox\ConferenceCall\Output\KeywordIdentification\cric1_newtotal_jason_new.xlsx", firstrow(variables) replace
